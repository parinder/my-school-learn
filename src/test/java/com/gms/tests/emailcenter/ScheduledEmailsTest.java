...
import com.gms.pages.emailcenter.email.HtmlTabPage;
import com.gms.pages.emailcenter.email.ScheduleEmailTabPage;
import com.gms.pages.emailcenter.ScheduledEmailsTabPage;
import com.gms.pages.emailcenter.email.SetupTabPage;
import com.gms.pages.emailcenter.email.TestTabPage;
...
public class ScheduledEmailsTest extends BaseFunctionalTest {
        ...
        protected com.gms.pages.emailcenter.HeaderPage emailCenterHeaderPage;
        protected com.gms.pages.emailcenter.email.HeaderPage emailHeaderPage;
        ...
        public void setup() throws IOException {
                super.setup();
                this.emailCenterHeaderPage = new com.gms.pages.emailcenter.HeaderPage(this.driver, config);
                this.scheduledEmailsTabPage = new ScheduledEmailsTabPage(this.driver, config);
                this.emailHeaderPage = new com.gms.pages.emailcenter.email.HeaderPage(this.driver, config);
